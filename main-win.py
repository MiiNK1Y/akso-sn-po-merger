...
# THIS ONE IS MADE TO SUPPOR WINDOWS ANSI BY INITIALIZING COLORAMA WINDOWS SUPPORT
...
# WITH THIS CALL, FOR SOME REASON THIS FIXES EVERYTHING ON THE WINDOWS .EXE, GREAT.
